   ...
   timer = new javax.swing.Timer(1000, new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            if (secondsPassed >= 15 * 60) { 
                ...
                JOptionPane.showMessageDialog(Java.this, "Time's up!");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("5)  Which keyword is used for accessing the features of a package?");
        ...
        rdoAnswer1.setText("Use of pointers");
        ...
        rdoOne2.setText("Object-oriented");
        jPanel1.add(rdoOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 160, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("1)  Which of the following is not a Java features?");
        ...
        rdoTwo1.setText("It has only methods");
        ...
        rdoTwo2.setText("Objects can't be created");
        ...
        rdoAnswer2.setText("It has no class name");
        jPanel1.add(rdoAnswer2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 230, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("2)  Which of the following is true about the anonymous inner class?  ");
        ...
        rdoAnswer3.setText("java.util package");
        ...
        rdoThree1.setText("java.lang package");
        jPanel1.add(rdoThree1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, -1, -1));

        rdoThree2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoThree2.setText("java.io package");
        jPanel1.add(rdoThree2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("3)  Which package contains the Random class?");
        ...
        rdoAnswer4.setText("Heap memory");
        ...
        rdoFour1.setText("Random storage space");
        ...
        rdoFour2.setText("String memory");
        jPanel1.add(rdoFour2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 370, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("4)  In which memory a String is stored, when we create a string using new operator?");
        ...
        rdoFive2.setText(" export");
        jPanel1.add(rdoFive2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 440, -1, -1));
        ...
        jPanel1.add(btnSub, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 460, 100, 40));
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        Result r1 = new Result("Java");
        if (percent >= 80) {
            String main = "Congratulations " + Login.getUsername() + "  !!!";
            String head = "You have passed the java Quiz !!!";

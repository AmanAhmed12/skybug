...
public class Javascript extends javax.swing.JFrame {
private javax.swing.ButtonGroup buttonGroup1;
        ...
        timer = new javax.swing.Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (secondsPassed >= 15 * 60) {
                    ...
                    JOptionPane.showMessageDialog(Javascript.this, "Time's up!");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("5) Which one of the following is an ternary operator:");
        ...
        rdoAnswer1.setText("Declaration statements");
        ...
        rdoOne2.setText("Data types");
        jPanel1.add(rdoOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 160, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("1)  The \"function\" and \" var\" are known as:");
        ...
        rdoTwo2.setText("Triggering Event");
        jPanel1.add(rdoTwo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, -1, -1));

        rdoAnswer2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoAnswer2.setText("Function/Method");
        jPanel1.add(rdoAnswer2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 230, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("2)  Which one of the following is the correct way for calling the JavaScript code?");
        ...
        rdoAnswer3.setText("Mutable variable");
        ...
        rdoThree1.setText("Dynamic variable");
        ...
        rdoThree2.setText("Immutable variable");
        jPanel1.add(rdoThree2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("3)   Which of the following type of a variable is volatile?");
        ...
        rdoAnswer4.setText("Division by zero");
        ...
        rdoFour1.setText("Syntax error");
        jPanel1.add(rdoFour1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 370, -1, -1));

        rdoFour2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoFour2.setText("Missing of semicolons");
        jPanel1.add(rdoFour2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 370, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("4) In the JavaScript, which one of the following is not considered as an error:");
        ...
        rdoAnswer5.setText("?");
        jPanel1.add(rdoAnswer5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 440, -1, -1));

        rdoFive2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoFive2.setText("+ ");
        jPanel1.add(rdoFive2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, -1, -1));
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        Result r1 = new Result("Javascript");
        if (percent >= 80) {
            String main = "Congratulations " + Login.getUsername() + "  !!!";
            String head = "You have passed the Javascript Quiz !!!";

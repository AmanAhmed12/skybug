...
public class Html extends javax.swing.JFrame {
        ...
        timer = new javax.swing.Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (secondsPassed >= 15 * 60) {
                    ...
                    JOptionPane.showMessageDialog(Html.this, "Time's up!");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HTML - QUIZ");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("5)  Which character is used to represent the closing of a tag in HTML?");
        ...
        rdoOne2.setText("<br>");
        jPanel1.add(rdoOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 160, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("1) Which of the following element is responsible for making the text bold in HTML?");
        ...
        rdoAnswer2.setText("<h1>");
        jPanel1.add(rdoAnswer2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("2)  Which of the following tag is used for inserting the largest heading in HTML?");
        ...
        rdoThree2.setText("<pre>");
        jPanel1.add(rdoThree2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("3) Which of the following tag is used to insert a line-break in HTML?");
        ...
        jLabel6.setText("4) How to create an unordered list (a list with the list items in bullets) in HTML?");
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        Result r1 = new Result("Html");
        if (percent >= 80) {
            String main = "Congratulations " + Login.getUsername() + "  !!!";
            String head = "You have passed the Html Quiz !!!";

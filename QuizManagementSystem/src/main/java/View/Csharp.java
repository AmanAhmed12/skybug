...
public class Csharp extends javax.swing.JFrame {
        ...
        timer = new javax.swing.Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (secondsPassed >= 15 * 60) {
                    ...
                    JOptionPane.showMessageDialog(Csharp.this, "Time's up!");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("C# - QUIZ");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("5) Which of the following method helps in returning more than one value?");
        ...
        rdoOne1.setText("abstract");
        jPanel1.add(rdoOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, -1, -1));

        rdoAnswer1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoAnswer1.setText(" All of the above.");
        jPanel1.add(rdoAnswer1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 160, -1, -1));

        rdoOne2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoOne2.setText(" foreach");
        jPanel1.add(rdoOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 160, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setText("1)  Which of the following is a reserved keyword in C#?");
        ...
        rdoTwo2.setText(" ToInt16");
        jPanel1.add(rdoTwo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, -1, -1));

        rdoAnswer2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoAnswer2.setText("ToDouble");
        jPanel1.add(rdoAnswer2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 230, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("2)  Which of the following converts a type to a double type in C#?");
        ...
        rdoThree1.setText("is");
        jPanel1.add(rdoThree1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, -1, -1));

        rdoThree2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoThree2.setText("as");
        jPanel1.add(rdoThree2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 300, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel5.setText("3)  Which of the following operator represents a conditional operation in C#?");
        ...
        rdoFour2.setText("Protected");
        jPanel1.add(rdoFour2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 370, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("4)  Which of the following is the default access specifier of a class member variable?");
        ...
        rdoFive1.setText("Value parameters");
        jPanel1.add(rdoFive1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, -1, -1));

        rdoAnswer5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoAnswer5.setText("Output parameters");
        jPanel1.add(rdoAnswer5, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 440, -1, -1));

        rdoFive2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        rdoFive2.setText("None of the above.");
        jPanel1.add(rdoFive2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 440, -1, -1));
        ...
        jPanel1.add(btnSub, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 460, 100, 40));
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        Result r1 = new Result("C#");
        if (percent >= 80) {
            String main = "Congratulations " + Login.getUsername() + "  !!!";
            String head = "You have passed the C-Sharp Quiz !!!";
